...
""";
        ...
        public static void CallSnakeHand(Player Convener, List<Player> PlayerList)
        {
            ...
            if (Convener != null)
                Convener.AddHint($"<i>{SnakeHands.Count()}명의 <color=#FE2EF7>동료</color>들이 당신과 함께합니다..</i>", 5f);
        }
