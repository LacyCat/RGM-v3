...
namespace RGM.Modes.ABattleVariables
{
    public static class Abilities
    {
        public static Dictionary<string, string> CommonAbilities = new Dictionary<string, string>()
        {
            ...
            {"[일반] 신내림", "당신을 지켜보는 관전자가 나타나면 능력 2~3개를 추가로 얻습니다. (시간 제한: 10초)"},
            ...
            {"[일반] 기도", "만일 신내림을 시도 중인 유저가 존재한다면 능력 2~3개를 추가로 얻습니다. (시간 제한: 10초)"}
        };
        ...
        public static Dictionary<string, string> MythicAbilities = new Dictionary<string, string>()
        {
            ...
            {"[신화] 광전사", "제일버드 폭발 데미지에 사망하지 않습니다. 내구도가 무한인 제일버드를 획득합니다."}
        };
