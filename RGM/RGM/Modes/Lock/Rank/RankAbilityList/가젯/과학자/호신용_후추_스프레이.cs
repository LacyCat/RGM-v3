...
{
    [RankGadget("호신용_후추_스프레이", "근접해 있는 적에게 일시적으로 부식과 흐릿함 효과를 부여합니다.", RankAbilityType.호신용_후추_스프레이, RankCategory.과학자, "🎢", 90)]
    public class 호신용_후추_스프레이 : RankGadgetAbility
    {
        protected override void OnGadgetUsed()
        {
            ...
            {
                enemy.AddEffect(EffectType.Blinded, 10, 2);
                enemy.AddEffect(EffectType.Corroding, 1, 2);
            }
        }
    }
}
