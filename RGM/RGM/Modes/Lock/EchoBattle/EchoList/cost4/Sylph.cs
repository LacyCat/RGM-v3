...
[Echo("실프", "10초간 이동 속도 30% 증가 및 문 통과/반투명화/발소리 제거 효과 적용. 재사용 대기시간 60초", EchoType.Sylph, EchoCost.Cost4, EchoMainStatType.MoveSpeedAndJump, "🌬️")]
public class Sylph : EchoActiveAbility
{
    public override float Duration => 10f;
    public override float Cooldown => 60f;
    public override string ActiveDescription => "10초간 이속 30% + 문 통과/반투명화/발소리 제거";

    protected override void OnActiveUsed()
    {
        Owner.AddEffect(EffectType.MovementBoost, 30, Duration);
