...
""";
        ...
        public IEnumerator<float> OnModeStarted()
        {
            ...
            Player.List.ToList().ForEach(x => x.AddHint("초록 불", $"<color=green>초록 불</color>! 움직여도 됩니다.", 250));
            ...
            while (true)
            {
                ...
                Light = "Red";
                Player.List.ToList().ForEach(x => x.AddHint("빨간 불", $"<color=red>빨간 불</color>! 움직이지 마세요!", 250));
